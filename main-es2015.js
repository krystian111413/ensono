...
const routes = [
    {
        path: 'issues',
        loadChildren: () => _issues_issues_module__WEBPACK_IMPORTED_MODULE_3__["IssuesModule"]
    },
    {
        path: '**',
        redirectTo: 'issues'
...
IssuesListComponent.ctorParameters = () => [
...
let IssuesSearcherComponent = class IssuesSearcherComponent {
    constructor(formBuilder, issuesSearcherService) {
    ...
    subscribeSearchForm() {
        this.searchForm
            ...
            .searchText
            .valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(value => value.trim()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((value) => value.length > 2)).subscribe(value => {
...
IssuesSearcherComponent.ctorParameters = () => [
